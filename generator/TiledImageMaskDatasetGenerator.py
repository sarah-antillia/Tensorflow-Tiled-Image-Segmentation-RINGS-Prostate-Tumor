...
if __name__ == "__main__":
  try:
    input_images_dir = "./Prostate-Train-Tumor-512x3-master/images/"
    input_masks_dir  = "./Prostate-Train-Tumor-512x3-master/masks/"

    output_images_dir = "./RINGS-Tiled-Prostate-Tumor/images/"
    output_masks_dir  = "./RINGS-Tiled-Prostate-Tumor/masks/"
